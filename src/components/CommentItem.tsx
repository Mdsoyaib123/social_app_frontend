            ...
            <div className="flex-1">
                ...
                <div className="flex items-center gap-4 text-xs text-gray-500 mt-1 pl-1">
                    <button
                        ...
                        className={`hover:underline flex items-center gap-1 cursor-pointer transition ${isLikedByMe
                ...
                {showReplies && (
                    <>
                        <div className="mt-3 flex items-center gap-2">
                            ...
                            <div className="flex-1 flex items-center bg-gray-100 rounded-full px-3 py-1">
                                ...
                                <button
                                    onClick={handleReply}
                                    disabled={isReplying}
                                    className="text-blue-500 text-xs font-medium cursor-pointer hover:text-blue-600 disabled:opacity-50"
                                >
                                    {isReplying ? (
                        ...
                        <div className="mt-3">
                            ...
                            {groupRepliesByUser(repliesData?.data || []).map(
                                (group: any) => (
                ...
                {showLikesHover && likeCount > 0 && (
                    <div className="absolute bottom-full mb-2 left-0 w-64 bg-white shadow-xl rounded-xl border p-3 z-50">
                        <p className="text-xs text-gray-400 mb-2">Liked by</p>
